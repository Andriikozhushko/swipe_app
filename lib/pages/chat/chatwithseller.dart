...
class ChatWithSeller extends StatefulWidget {
  const ChatWithSeller({Key? key}) : super(key: key);

  @override
  ChatWithSellerState createState() => ChatWithSellerState();
}
                    ...
                    onPressed: () {
                      ...
                      if (messageText.isNotEmpty) {
                        ...
                        Future.delayed(const Duration(seconds: 2), () {
                          _addMessage(
                            isMine: false,
                            text: 'Здравствуйте, отвечу вам в 7 вечера',
                            textStyle: chatText1,
                          );
                        });
                      }
