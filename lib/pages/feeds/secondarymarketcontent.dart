...
class SecondaryMarketTabContent extends StatefulWidget {
  final bool isEnabled;
  const SecondaryMarketTabContent({Key? key, required this.isEnabled})
      : super(key: key);

  @override
  SecondaryMarketTabContentState createState() =>
      SecondaryMarketTabContentState();
}

class SecondaryMarketTabContentState extends State<SecondaryMarketTabContent> {
            ...
            children: [
              ...
              ExpansionTile(
                ...
                children: <Widget>[
                  Container(
                    padding:
                        const EdgeInsets.only(left: 17, right: 17, bottom: 22),
                    child: Column(
