...
class NewMarketTabContent extends StatefulWidget {
  final bool isEnabled;
  const NewMarketTabContent({Key? key, required this.isEnabled}) : super(key: key);

  @override
  NewMarketTabContentState createState() => NewMarketTabContentState();
}

class NewMarketTabContentState extends State<NewMarketTabContent> {
